    ...
    <div class="row">
        <div class="col-12 mb-2">
            ...
            <a href="{{ route('karyawan.create') }}">
                <button class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i>Tambah Karyawan</button>
            </a>

            <a href="{{ route('karyawan.index', ['ip' => "192.168.1.11"]) }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row justify-content-center">
                                        <form action="{{ route('karyawan.destroy', $karyawan->id) }}" method="post" onsubmit="return confirm('Yakin untuk hapus data ini?')">
                                            @csrf
                                            @method('DELETE')
